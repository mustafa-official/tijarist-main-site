  ...
  return (
    <div className="my-8 md:my-12 lg:my-16 max-w-5xl mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-x-12 gap-y-8 mt-10">
        <div className="bg-[#EDFAFA] flex justify-center items-center rounded-3xl min-h-[350px]">
          <img
            src={start1}
            className="max-w-full h-auto px-8 sm:px-12 py-8 md:py-0"
            alt=""
          />
        </div>
        ...
        <div>
          ...
          <p className="text-[#555151] text-sm md:text-[16px] mt-5 md:mt-7 leading-6">
            From building your first website and registering your domain to
        ...
        <div className="bg-[#FFF4EA] flex justify-center items-center rounded-3xl min-h-[350px]">
          <img
            src={start2}
            className="max-w-full h-auto px-8 sm:px-12 py-8 md:py-0 object-contain"
            alt=""
          />
        </div>

        <div className="bg-[#FAEDF5] flex justify-center items-center rounded-3xl min-h-[350px]">
          <img
            src={start3}
            className="max-w-full h-auto px-8 sm:px-12 py-8 md:py-0"
            alt=""
