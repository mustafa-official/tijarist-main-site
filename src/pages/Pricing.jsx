  ...
  return (
    <div className="my-8 md:my-12 lg:my-16 max-w-5xl mx-auto px-4">
      ...
      <div className="mt-14 md:mt-16 lg:mt-20">
        <h2 className="font-semibold text-2xl mb-8 md:text-3xl text-black text-center">
          Compare Plans and Features
        </h2>
        <div className="bg-white/40 backdrop-blur-sm rounded-3xl text-black border border-[#00000040] overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="bg-[#FFF4EA] text-[18px]">
                  <th className="text-left py-4 px-6 font-medium">
                    Support Features
                  </th>
                  <th className="py-4 px-6  font-medium">Basic</th>
                  <th className="py-4 px-6  font-medium">Advanced</th>
                  <th className="py-4 px-6  font-medium">Plus</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  >
                    ...
                    <td className="py-4 px-6 text-center">
                      {feature.type === "boolean" ? (
                        feature.basic ? (
                          <IoCheckmarkCircleSharp className="w-5 h-5 text-purple-600 mx-auto" />
                        ) : (
                          <IoCloseCircleSharp className="w-5 h-5 text-[#E7E0EB] mx-auto" />
                        )
                      ) : (
                        <span className="">{feature.basic}</span>
                      )}
                    </td>
                    <td className="py-4 px-6 text-center">
                      {feature.type === "boolean" ? (
                        ...
                        <span className="">{feature.advanced}</span>
                      )}
                    </td>
                    <td className="py-4 px-6 text-center">
                      {feature.type === "boolean" ? (
